...
public class SocketFactoryDinamico implements ProtocolSocketFactory { 
    ...
    private SSLContext createSSLContext() {  
        try {  
            ...
            //SSLContext sslContext = SSLContext.getInstance("TLS"); //comentei dia 13/01/2017
            SSLContext sslContext = SSLContext.getInstance("TLSv1.2"); // posivel alteraçao dia 13/01/2017
