...
CREATE TABLE IF NOT EXISTS CLASSIFICACAO_TRIBUTARIA (
    ...
    CLTR_TIPO_ALIQUOTA TEXT NOT NULL DEFAULT 'Padrão' CHECK (CLTR_TIPO_ALIQUOTA IN (
        ...
        'Referência',
        'Ad Rem (por NCM)',
        'Ad Valorem (por NCM ou NBS)',
        'Alíquotas Combinadas (Ad Valorem e Ad Rem)',
        'Alíquota Zero'
    )),
    CLTR_TIPO_CREDITO_OPERACAO_ANTECEDENTE TEXT CHECK (CLTR_TIPO_CREDITO_OPERACAO_ANTECEDENTE IN (
    ...
    FOREIGN KEY(CLTR_CREDITO_PARA_FRENTE_FDLG_ID) REFERENCES FUNDAMENTACAO_LEGAL(FDLG_ID),
