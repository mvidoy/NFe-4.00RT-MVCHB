...
import br.gov.serpro.rtc.api.model.roc.total.aux.MonofasiaTotalAccumulator;
...
public class MonofasiaTotal {
    ...
    public static MonofasiaTotal create(List<DetalheImposto> detalhes) {
    ...
    private static boolean possuiMonofasia(List<DetalheImposto> detalhes) {
        return detalhes.parallelStream().anyMatch(condicaoPossuiMonofasia());
    }

    private static Predicate<? super DetalheImposto> condicaoPossuiMonofasia() {
        return d -> d.possuiMonofasia();
    }
}
