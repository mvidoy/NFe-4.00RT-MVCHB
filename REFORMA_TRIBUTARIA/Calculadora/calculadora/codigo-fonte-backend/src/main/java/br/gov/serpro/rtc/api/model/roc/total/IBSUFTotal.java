...
import br.gov.serpro.rtc.api.model.roc.total.aux.IBSUFTotalAccumulator;
...
public class IBSUFTotal {
    ...
    public static IBSUFTotal create(List<DetalheImposto> detalhes) {
    ...
    private static boolean possuiIbsUF(List<DetalheImposto> detalhes) {
        return detalhes.parallelStream().anyMatch(condicaoPossuiIbsUF());
    }
    
    private static Predicate<? super DetalheImposto> condicaoPossuiIbsUF() {
