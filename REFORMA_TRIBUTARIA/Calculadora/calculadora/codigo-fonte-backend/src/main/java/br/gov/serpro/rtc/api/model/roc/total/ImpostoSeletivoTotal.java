...
public class ImpostoSeletivoTotal {
    ...
    public static ImpostoSeletivoTotal create(List<DetalheImposto> detalhes) {
    ...
    private static boolean possuiImpostoSeletivo(List<DetalheImposto> detalhes) {
        return detalhes.parallelStream().anyMatch(condicaoPossuiIS());
    }

    private static BigDecimal getValorTotalIS(List<DetalheImposto> detalhes) {
    ...
    private static Predicate<? super DetalheImposto> condicaoPossuiIS() {
