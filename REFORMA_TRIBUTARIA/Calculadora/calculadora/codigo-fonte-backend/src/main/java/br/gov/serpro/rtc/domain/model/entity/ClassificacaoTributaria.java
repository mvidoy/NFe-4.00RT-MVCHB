...
public class ClassificacaoTributaria {
    ...
    @Column(name = "CLTR_IN_CREDITO_PARA_FRENTE")
    private Boolean inCreditoParaFrente;
    ...
    @ManyToOne
    @JoinColumn(name = "CLTR_CREDITO_PARA_FRENTE_FDLG_ID")
    private FundamentacaoLegal fundamentacaoLegalCreditoParaFrente;
    ...
    @Column(name = "CLTR_TIPO_CREDITO_OPERACAO_ANTECEDENTE")
    private String tipoCreditoOperacaoAntecedente;
