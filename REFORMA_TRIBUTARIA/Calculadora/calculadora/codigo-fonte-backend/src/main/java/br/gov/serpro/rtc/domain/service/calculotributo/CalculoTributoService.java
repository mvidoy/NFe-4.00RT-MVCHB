...
import br.gov.serpro.rtc.api.model.roc.imposto.CBS;
import br.gov.serpro.rtc.api.model.roc.imposto.CompraGovernamental;
import br.gov.serpro.rtc.api.model.roc.imposto.CreditoPresumido;
import br.gov.serpro.rtc.api.model.roc.imposto.CreditoPresumidoIBSZonaFrancaManaus;
import br.gov.serpro.rtc.api.model.roc.imposto.DevolucaoTributos;
import br.gov.serpro.rtc.api.model.roc.imposto.GrupoIBSCBS;
import br.gov.serpro.rtc.api.model.roc.imposto.IBSCBS;
import br.gov.serpro.rtc.api.model.roc.imposto.IBSMun;
import br.gov.serpro.rtc.api.model.roc.imposto.IBSUF;
import br.gov.serpro.rtc.api.model.roc.imposto.ImpostoSeletivo;
import br.gov.serpro.rtc.api.model.roc.imposto.Monofasia;
import br.gov.serpro.rtc.api.model.roc.imposto.Monofasia.MonofasiaBuilder;
import br.gov.serpro.rtc.api.model.roc.imposto.TransferenciaCredito;
import br.gov.serpro.rtc.api.model.roc.imposto.TributacaoRegular;
import br.gov.serpro.rtc.api.model.roc.imposto.TributacaoRegular.TributacaoRegularBuilder;
import br.gov.serpro.rtc.api.model.roc.imposto.Tributos;
...
public class CalculoTributoService {
    ...
    private static CompraGovernamental getCompraGovernamental(CbsIbsOutput cbs, 
    ...
    private static CreditoPresumidoIBSZonaFrancaManaus getCreditoPresumidoIBSZFM(CbsIbsOutput ibsEstadual, 
            CbsIbsOutput ibsMunicipal) {
        return null;
    }
