...
public class IBSTotal {
    ...
    public static IBSTotal create(List<DetalheImposto> detalhes) {
    ...
    private static BigDecimal getValorCreditoPresumidoTotal(List<DetalheImposto> detalhes) {
    ...
    private static BigDecimal getValorCreditoPresumidoCondSusTotal(List<DetalheImposto> detalhes) {
    ...
    private static boolean possuiCondicao(List<DetalheImposto> detalhes, Predicate<? super DetalheImposto> condicao) {
        return detalhes.parallelStream().anyMatch(condicao);
    }

    private static Predicate<? super DetalheImposto> condicaoPossuiCreditoPresumido() {
        return d -> d.possuiCredPresIbs();
    }
    
    private static Predicate<? super DetalheImposto> condicaoPossuiCreditoPresumidoCondSus() {
