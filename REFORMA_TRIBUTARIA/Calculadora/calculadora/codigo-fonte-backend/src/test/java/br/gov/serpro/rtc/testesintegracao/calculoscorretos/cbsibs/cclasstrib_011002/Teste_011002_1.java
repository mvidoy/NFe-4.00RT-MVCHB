...
*/
package br.gov.serpro.rtc.testesintegracao.calculoscorretos.cbsibs.cclasstrib_011002;
...
class Teste_011002_1 {
    ...
    void testCalcularTributos(
            final @Value("classpath:entradas/calculoscorretos/Teste_011002_1.json") Resource resourceFile)
            throws Exception {
    ...
    private static void assertGrupoReducao(final ReducaoAliquota grupoReducao, final String reducao,
