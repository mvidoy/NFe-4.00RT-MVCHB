...
class Teste_200032_4 {
    ...
    void testCalcularTributos(
            final @Value("classpath:entradas/calculoscorretos/Teste_200032_4.json") Resource resourceFile)
            throws Exception {
        ...
        assertTributacaoRegular(item, "3.36", "8.31", "0.02", "0.05", "0.02", "0.05");
    ...
    private void assertTributacaoRegular(final DetalheImposto item, final String aliquotaRegularCBS,
