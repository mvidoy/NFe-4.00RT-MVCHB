...
class Teste_200032_3 {
    ...
    void testCalcularTributos(
            final @Value("classpath:entradas/calculoscorretos/Teste_200032_3.json") Resource resourceFile)
            throws Exception {
        ...
        assertTributacaoRegular(item, "0.36", "0.72", "0.04", "0.08", "0.00", "0.00");
