...
class Teste_000001_7 {
    ...
    void testCalcularTributos(
            final @Value("classpath:entradas/calculoscorretos/Teste_000001_7.json") Resource resourceFile)
            throws Exception {
        ...
        var item = resultado.getDet().get(0);
        ...
        assertTributacaoRegular(item, "7.40", "14.80", "1.50", "3.00", "1.05", "2.10");
    ...
    private void assertCbs(final CBS cbs) {
        ...
        isEqualByComparingTo(cbs.getAliquota(), "7.40");
