...
*/
package br.gov.serpro.rtc.testesintegracao.calculoscorretos.cbsibs.cclasstrib_200001;
...
class Teste_200001_4 {
    ...
    void testCalcularTributos(
            final @Value("classpath:entradas/calculoscorretos/Teste_200001_4.json") Resource resourceFile)
            throws Exception {
    ...
    private void assertTributacaoRegular(final DetalheImposto item, final BigDecimal aliquotaRegularCBS,
