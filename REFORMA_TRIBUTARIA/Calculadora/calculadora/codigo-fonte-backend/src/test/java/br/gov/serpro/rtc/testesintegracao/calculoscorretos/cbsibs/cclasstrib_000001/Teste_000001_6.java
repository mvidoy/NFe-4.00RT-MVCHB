...
class Teste_000001_6 {
    ...
    void testCalcularTributos(
            final @Value("classpath:entradas/calculoscorretos/Teste_000001_6.json") Resource resourceFile)
            throws Exception {
    ...
    private void assertCbs(final CBS cbs) {
        ...
        isEqualByComparingTo(cbs.getValorImposto(), "15.58");
    }
    ...
    private void assertImpostoSeletivo(ImpostoSeletivo impostoSeletivo) {
        ...
        isEqualByComparingTo(impostoSeletivo.getVIS(), "10.54");
    }
}